...
async def generateFeedback(prompt):
    try:
        prompt_add_on = "Generate a progress report of the patient for the same. It should sound like a doctor is suggesting something, i.e., it should be in 1st person. Suggest lifestyle changes to cure arthritis based on the progress of patient. Output should be in HTML - no basic structure just give the output using p tag and other tags like b, i, etc. Apply basic inline css so that it doesn't look odd"
